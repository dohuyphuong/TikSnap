# Consuming Quick Mark Design System in Expo apps

Read `artifacts/quick-mark-system/docs/AGENTS.md` first. React Native does
...
`artifacts/quick-mark-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/quick-mark-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/quick-mark-system/lib/native-theme";
...
```tsx
import { Badge } from "@workspace/quick-mark-system/components/native/badge";
import { Button } from "@workspace/quick-mark-system/components/native/button";
import { Card } from "@workspace/quick-mark-system/components/native/card";
```
...
Import and render
`@workspace/quick-mark-system/components/native/button`, then run Expo
