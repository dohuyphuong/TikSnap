# Migrating web UI to Quick Mark Design System

Read `artifacts/quick-mark-system/docs/AGENTS.md` and
`artifacts/quick-mark-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/quick-mark-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/quick-mark-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/quick-mark-system/hooks/use-toast`
